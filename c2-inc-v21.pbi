...
Enumeration
   ...
   #ljBUILTIN_COS          ; cos(x) - cosine (radians)
   #ljBUILTIN_TAN          ; tan(x) - tangent (radians)
   #ljBUILTIN_ASIN         ; asin(x) - arc sine
   #ljBUILTIN_ACOS         ; acos(x) - arc cosine
   #ljBUILTIN_ATAN         ; atan(x) - arc tangent
   #ljBUILTIN_ATAN2        ; atan2(y, x) - arc tangent of y/x
   #ljBUILTIN_SINH         ; sinh(x) - hyperbolic sine
   #ljBUILTIN_COSH         ; cosh(x) - hyperbolic cosine
   #ljBUILTIN_TANH         ; tanh(x) - hyperbolic tangent
   #ljBUILTIN_LOG          ; log(x) - natural logarithm
   #ljBUILTIN_LOG10        ; log10(x) - base-10 logarithm
   #ljBUILTIN_EXP          ; exp(x) - e^x
   #ljBUILTIN_FLOOR        ; floor(x) - round down
   #ljBUILTIN_CEIL         ; ceil(x) - round up
   #ljBUILTIN_ROUND        ; round(x) - round to nearest
   #ljBUILTIN_SIGN         ; sign(x) - returns -1, 0, or 1
   #ljBUILTIN_MOD          ; mod(a, b) - modulo (float-safe)
   #ljBUILTIN_FABS         ; fabs(x) - absolute value (float)
   #ljBUILTIN_FMIN         ; fmin(a, b) - minimum (float)
   #ljBUILTIN_FMAX         ; fmax(a, b) - maximum (float)

   ;- V1.038.0: SpiderBasic String Library Builtins
   #ljBUILTIN_LEFT         ; left(s, n) - left n characters
   #ljBUILTIN_RIGHT        ; right(s, n) - right n characters
   #ljBUILTIN_MID          ; mid(s, start, len) - substring
   #ljBUILTIN_TRIM         ; trim(s) - remove leading/trailing whitespace
   #ljBUILTIN_LTRIM        ; ltrim(s) - remove leading whitespace
   #ljBUILTIN_RTRIM        ; rtrim(s) - remove trailing whitespace
   #ljBUILTIN_LCASE        ; lcase(s) - convert to lowercase
   #ljBUILTIN_UCASE        ; ucase(s) - convert to uppercase
   #ljBUILTIN_CHR          ; chr(n) - character from code
   #ljBUILTIN_ASC          ; asc(s) - code from first character
   #ljBUILTIN_FINDSTRING   ; findstring(s, find, start) - find substring
   #ljBUILTIN_REPLACESTRING ; replacestring(s, find, replace) - replace all occurrences
   #ljBUILTIN_COUNTSTRING  ; countstring(s, find) - count occurrences
   #ljBUILTIN_REVERSESTRING ; reversestring(s) - reverse string
   #ljBUILTIN_INSERTSTRING ; insertstring(s, insert, pos) - insert at position
   #ljBUILTIN_REMOVESTRING ; removestring(s, remove) - remove all occurrences
   #ljBUILTIN_SPACE        ; space(n) - n spaces
   #ljBUILTIN_LSET         ; lset(s, n) - left-pad/truncate to n chars
   #ljBUILTIN_RSET         ; rset(s, n) - right-pad/truncate to n chars
   #ljBUILTIN_STRFLOAT     ; strfloat(s) - string to float (atof)
   #ljBUILTIN_STRINT       ; strint(s) - string to int (atoi)
   #ljBUILTIN_HEX          ; hex(n) - integer to hex string
   #ljBUILTIN_BIN          ; bin(n) - integer to binary string
   #ljBUILTIN_VALF         ; valf(s) - string to float (alias)
   ...
   ;- V1.038.0: SpiderBasic Cipher Builtins
   #ljBUILTIN_MD5          ; md5(s) - MD5 hash
   #ljBUILTIN_SHA1         ; sha1(s) - SHA1 hash
   #ljBUILTIN_SHA256       ; sha256(s) - SHA256 hash
   #ljBUILTIN_SHA512       ; sha512(s) - SHA512 hash
   #ljBUILTIN_CRC32        ; crc32(s) - CRC32 checksum
   #ljBUILTIN_BASE64ENC    ; base64enc(s) - Base64 encode
   #ljBUILTIN_BASE64DEC    ; base64dec(s) - Base64 decode

   ;- V1.038.0: SpiderBasic JSON Builtins
   #ljBUILTIN_JSONPARSE    ; jsonparse(s) - parse JSON string, returns handle
   #ljBUILTIN_JSONFREE     ; jsonfree(h) - free JSON handle
   #ljBUILTIN_JSONVALUE    ; jsonvalue(h) - get root value as string
   #ljBUILTIN_JSONTYPE     ; jsontype(h) - get type (0=null,1=string,2=number,3=bool,4=array,5=object)
   #ljBUILTIN_JSONMEMBER   ; jsonmember(h, key) - get object member by key
   #ljBUILTIN_JSONELEMENT  ; jsonelement(h, idx) - get array element by index
   #ljBUILTIN_JSONSIZE     ; jsonsize(h) - get array/object size
   #ljBUILTIN_JSONSTRING   ; jsonstring(h) - get string value
...
Global               gObjectLoaded.b = #False           ; V1.039.0: True if .od file was loaded (skip compile)
...
; V1.039.21: Map for ASM local variable name display - key: "funcId_paramOffset" -> variable name
Global NewMap        gAsmLocalNameMap.s()
...
Global gAsmDebugMode.i = #False    ; V1.039.20: --asm-debug mode (include FLAGS, slot info)
Global gAsmDecimalMode.i = #False  ; V1.039.20: --asm-decimal mode (decimal line numbers instead of hex)
...
Macro _EscapeString(str)
   _asmEscapedStr = str
   _asmEscapedStr = ReplaceString(_asmEscapedStr, Chr(92), "\\")   ; backslash first
   _asmEscapedStr = ReplaceString(_asmEscapedStr, Chr(10), "\n")   ; newline
   _asmEscapedStr = ReplaceString(_asmEscapedStr, Chr(13), "\r")   ; carriage return
   _asmEscapedStr = ReplaceString(_asmEscapedStr, Chr(9), "\t")    ; tab
EndMacro
...
Macro _GetLocalName(paramOffset)
   ...
   Else
      _asmLocalKey = "_" + Str(paramOffset)
   EndIf
   If FindMapElement(gAsmLocalNameMap(), _asmLocalKey)
      gAsmLocalName = "[_" + gAsmLocalNameMap() + "]"
   Else
      gAsmLocalName = "[_L" + Str(paramOffset) + "]"
   EndIf
EndMacro

Macro          ASMLine(obj,show)
   ; V1.039.20: Streamlined format - hex (default) or decimal (--asm-decimal)
   CompilerIf show = 1
      If gAsmDecimalMode
         line = RSet( Str( i + 1 ), 6 ) + ":  "
      Else
         line = RSet( Hex( i + 1, #PB_Word ), 4, "0" ) + ":  "
      EndIf
   CompilerElse
      If gAsmDecimalMode
         line = RSet( Str( ListIndex(obj) ), 6 ) + ":  "
      Else
         line = RSet( Hex( ListIndex(obj), #PB_Word ), 4, "0" ) + ":  "
      EndIf
   CompilerEndIf

   ; V1.026.10: Bounds check for ASMLine opcode display
   If obj\code >= 0 And obj\code < #C2TOKENCOUNT
      line + LSet( gszATR( obj\code )\s, 28 ) + "  "
   Else
      line + LSet( "UNKNOWN_" + Str(obj\code), 28 ) + "  "
      CompilerIf show = 1
   ...
   If obj\code = #ljJMP Or obj\code = #ljJZ Or obj\code = #ljJNZ
      CompilerIf show
         If gAsmDecimalMode
            line + Str(obj\i) + " -> " + RSet(Str(i+1+obj\i), 6)
         Else
            line + Str(obj\i) + " -> " + RSet(Hex(i+1+obj\i, #PB_Word), 4, "0")
         EndIf
      CompilerElse
         If gAsmDecimalMode
            line + Str(obj\i) + " -> " + RSet(Str(ListIndex(obj)+1+obj\i), 6)
         Else
            line + Str(obj\i) + " -> " + RSet(Hex(ListIndex(obj)+1+obj\i, #PB_Word), 4, "0")
         EndIf
      CompilerEndIf
   ElseIf obj\code = #ljCall Or obj\code = #ljCALL0 Or obj\code = #ljCALL1 Or obj\code = #ljCALL2 Or obj\code = #ljCALL_REC
      ...
      CompilerIf show
         ...
         Else
            If gAsmDecimalMode
               line + "-> " + RSet(Str(i+1+obj\i), 6)
            Else
               line + "-> " + RSet(Hex(i+1+obj\i, #PB_Word), 4, "0")
            EndIf
         EndIf
      CompilerElse
         ...
         _asmFuncName = ""
         If obj\funcid >= 0 And obj\funcid < #C2MAXFUNCTIONS
            _asmFuncName = gFuncNames(obj\funcid)
         EndIf
         ; V1.039.20: Clean format shows just function name, debug shows details
         If gAsmDebugMode
            If _asmFuncName = ""
   ...
   ElseIf obj\code = #ljSTORE Or obj\code = #ljSTORES Or obj\code = #ljSTOREF
      ...
      Else
         ...
         If gAsmDebugMode : line + " (slot=" + Str(obj\i) + " j=" + Str(obj\j) + ")" : EndIf
      EndIf
      flag + 1
   ...
   ElseIf obj\code = #ljPFETCH
      ...
      EndIf
      If gAsmDebugMode : line + " (ptr)" : EndIf
      flag + 1
   ...
   ElseIf obj\code = #ljPUSH Or obj\code = #ljFetch Or obj\code = #ljPUSHS Or obj\code = #ljPUSHF Or obj\code = #ljFETCHS Or obj\code = #ljFETCHF
      ...
      Else
         ...
         If gVarMeta( obj\i )\flags & #C2FLAG_IDENT
            ; V1.023.21: Show slot number only in debug mode
            If gAsmDebugMode
         ...
         ElseIf gVarMeta( obj\i )\flags & #C2FLAG_STR
            ; V1.039.26: Escape control characters for display
            _EscapeString(gVarMeta( obj\i )\valueString)
            line + Chr(34) + _asmEscapedStr + Chr(34)
         ElseIf gVarMeta( obj\i )\flags & #C2FLAG_INT
            line + Str(gVarMeta( obj\i )\valueInt)
         ElseIf gVarMeta( obj\i )\flags & #C2FLAG_FLOAT
            line + StrD(gVarMeta( obj\i )\valueFloat,3)
         Else
            line + gVarMeta( obj\i )\name
         EndIf
      EndIf
   ...
   ElseIf obj\code = #ljFLOATNEG
      flag + 1
      line + "[sp] = -[sp]"
      If gAsmDebugMode : line + " (float)" : EndIf
   ...
   ElseIf obj\code = #ljSTRADD
      line + "[sp-1] + [sp] --> [sp-1]"
      If gAsmDebugMode : line + " (str)" : EndIf
   ...
   ElseIf obj\code = #ljITOS
      line + "[sp] = str([sp])"
      If gAsmDebugMode : line + " (int)" : EndIf
   ...
   ElseIf obj\code = #ljDUP Or obj\code = #ljDUP_I Or obj\code = #ljDUP_F Or obj\code = #ljDUP_S
      line + "[sp] = [sp-1]"
      If gAsmDebugMode : line + " (dup)" : EndIf
...
Macro _INIT_OPCODE_NAMES
   ...
   gszATR(#ljBUILTIN_TAN)\s = "BI_TAN"
   gszATR(#ljBUILTIN_ASIN)\s = "BI_ASIN"
   gszATR(#ljBUILTIN_ACOS)\s = "BI_ACOS"
   gszATR(#ljBUILTIN_ATAN)\s = "BI_ATAN"
   gszATR(#ljBUILTIN_ATAN2)\s = "BI_ATAN2"
   gszATR(#ljBUILTIN_SINH)\s = "BI_SINH"
   gszATR(#ljBUILTIN_COSH)\s = "BI_COSH"
   gszATR(#ljBUILTIN_TANH)\s = "BI_TANH"
   gszATR(#ljBUILTIN_LOG)\s = "BI_LOG"
   gszATR(#ljBUILTIN_LOG10)\s = "BI_LOG10"
   gszATR(#ljBUILTIN_EXP)\s = "BI_EXP"
   gszATR(#ljBUILTIN_FLOOR)\s = "BI_FLOOR"
   gszATR(#ljBUILTIN_CEIL)\s = "BI_CEIL"
   gszATR(#ljBUILTIN_ROUND)\s = "BI_ROUND"
   gszATR(#ljBUILTIN_SIGN)\s = "BI_SIGN"
   gszATR(#ljBUILTIN_MOD)\s = "BI_MOD"
   gszATR(#ljBUILTIN_FABS)\s = "BI_FABS"
   gszATR(#ljBUILTIN_FMIN)\s = "BI_FMIN"
   gszATR(#ljBUILTIN_FMAX)\s = "BI_FMAX"
   ; V1.038.0: String builtins
   gszATR(#ljBUILTIN_LEFT)\s = "BI_LEFT"
   gszATR(#ljBUILTIN_RIGHT)\s = "BI_RIGHT"
   gszATR(#ljBUILTIN_MID)\s = "BI_MID"
   gszATR(#ljBUILTIN_TRIM)\s = "BI_TRIM"
   gszATR(#ljBUILTIN_LTRIM)\s = "BI_LTRIM"
   gszATR(#ljBUILTIN_RTRIM)\s = "BI_RTRIM"
   gszATR(#ljBUILTIN_LCASE)\s = "BI_LCASE"
   gszATR(#ljBUILTIN_UCASE)\s = "BI_UCASE"
   gszATR(#ljBUILTIN_CHR)\s = "BI_CHR"
   gszATR(#ljBUILTIN_ASC)\s = "BI_ASC"
   gszATR(#ljBUILTIN_FINDSTRING)\s = "BI_FINDSTR"
   gszATR(#ljBUILTIN_REPLACESTRING)\s = "BI_REPLSTR"
   gszATR(#ljBUILTIN_COUNTSTRING)\s = "BI_CNTSTR"
   gszATR(#ljBUILTIN_REVERSESTRING)\s = "BI_REVSTR"
   gszATR(#ljBUILTIN_INSERTSTRING)\s = "BI_INSSTR"
   gszATR(#ljBUILTIN_REMOVESTRING)\s = "BI_REMSTR"
   gszATR(#ljBUILTIN_SPACE)\s = "BI_SPACE"
   gszATR(#ljBUILTIN_LSET)\s = "BI_LSET"
   gszATR(#ljBUILTIN_RSET)\s = "BI_RSET"
   gszATR(#ljBUILTIN_STRFLOAT)\s = "BI_STRFLT"
   gszATR(#ljBUILTIN_STRINT)\s = "BI_STRINT"
   gszATR(#ljBUILTIN_HEX)\s = "BI_HEX"
   gszATR(#ljBUILTIN_BIN)\s = "BI_BIN"
   ...
   gszATR(#ljBUILTIN_MD5)\s = "BI_MD5"
   gszATR(#ljBUILTIN_SHA1)\s = "BI_SHA1"
   gszATR(#ljBUILTIN_SHA256)\s = "BI_SHA256"
   gszATR(#ljBUILTIN_SHA512)\s = "BI_SHA512"
   gszATR(#ljBUILTIN_CRC32)\s = "BI_CRC32"
   gszATR(#ljBUILTIN_BASE64ENC)\s = "BI_B64ENC"
   gszATR(#ljBUILTIN_BASE64DEC)\s = "BI_B64DEC"
   ; V1.038.0: JSON builtins
   gszATR(#ljBUILTIN_JSONPARSE)\s = "BI_JPARSE"
   gszATR(#ljBUILTIN_JSONFREE)\s = "BI_JFREE"
   gszATR(#ljBUILTIN_JSONVALUE)\s = "BI_JVALUE"
   gszATR(#ljBUILTIN_JSONTYPE)\s = "BI_JTYPE"
   gszATR(#ljBUILTIN_JSONMEMBER)\s = "BI_JMEMBER"
   gszATR(#ljBUILTIN_JSONELEMENT)\s = "BI_JELEM"
   gszATR(#ljBUILTIN_JSONSIZE)\s = "BI_JSIZE"
   gszATR(#ljBUILTIN_JSONSTRING)\s = "BI_JSTRING"
   gszATR(#ljBUILTIN_JSONNUMBER)\s = "BI_JNUMBER"
   gszATR(#ljBUILTIN_JSONBOOL)\s = "BI_JBOOL"
