            ...
            Case #INV$
               ...
               Else
                  ...
                  Repeat
                     ...
                     If gNextChar = #INV$
                        ; V1.038.2: FIX - String literals in quotes should ALWAYS be #ljSTRING
                        ; regardless of content (e.g., "3.14" is a string, not a float)
                        ; DetectType was incorrectly converting numeric-looking strings to INT/FLOAT
                        par_AddToken( #ljSTRING, #ljSTRING, "", text )
                        Break
                     ElseIf gNextChar = #CR$
